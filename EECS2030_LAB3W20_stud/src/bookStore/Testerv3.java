...
public class Testerv3 {
	...
	public void test02a_ctor() {
		...
		assertEquals("ctor set the wrong BookStoreOwner", w, b.getOwner());
	}
	...
	public void test03a_copyCtor() {
		...
		assertEquals("copy ctor set the wrong owner", w, c.getOwner());
	}
	...
	public void test04b_changeOwner() {
		...
		BookStoreOwner x = new BookStoreOwner("OwnerB");
		b.changeOwner(w, x);
		assertEquals("changeOwner failed to set the correct owner", x, b.getOwner());
	}
...
//contains
	...
	public void test06a_contains() {
		...
		assertFalse("contains returned true for an empty Bookstore!", b.contains(b1));
	...
	public void test06b_contains() {
		...
		assertTrue("contains returned false for a BookStore with every book", b.contains(b1));
		assertTrue("contains returned false for a BookStore with every book", b.contains(b2));
		assertTrue("contains returned false for a BookStore with every book", b.contains(b3));
		assertTrue("contains returned false for a BookStore with every book", b.contains(b4));
	...
	public void test06c_contains() {
		...
		assertTrue("contains returned true for a BookStore with only b1", b.contains(b1));
		assertFalse("contains returned false for a BookStore with only b1", b.contains(b2));
		assertFalse("contains returned false for a BookStore with only b1", b.contains(b3));
		assertFalse("contains returned false for BookStore with only b1", b.contains(b4));
	...
	public void test_comparator() {
		...
		List<Book> exp = new ArrayList<>(Arrays.asList(new Book("5G", 2000, 10), new Book("Java 1", 2010, 160),
				new Book("Signals and Systems", 2011, 260), new Book("Optical Communication", 2018, 30)));
