...
public class Tester {
	...
	public void test_getSortedPassengerInfo_normal() {
		...
		PassengerInfo[] expected = { new PassengerInfo("Heeyeon", 10, 2000), new PassengerInfo("Sunhye", 30, 2577),
				new PassengerInfo("Jiyoon", 50, 2577), new PassengerInfo("Yuna", 50, 990),
				new PassengerInfo("Suyeon", 70, 2577), new PassengerInfo("Jaebin", 70, 2000),
	...
	public void test_icketAmount_normal() {
		...
		try {
			...
			System.out.println(db.getAverageTicketAmount(2000));
			// +db.get));
			System.out.println((10 + 70) / 2.0);
	...
	@Test
	public void test1() {
		PassengerInfo p1 = new PassengerInfo("Jane", 3, 25);
		PassengerInfo p2 = new PassengerInfo("Suceey", 2, 50);
		PassengerInfo p3 = new PassengerInfo("Huan", 1, 200);
		PassengerInfo p4 = new PassengerInfo("Huan", 1, 200);
	...
	public void test2() {
		PassengerInfo p1 = new PassengerInfo("Jane", 3, 25);
		PassengerInfo p2 = new PassengerInfo("Suceey", 2, 25);
		PassengerInfo p3 = new PassengerInfo("Huan", 1, 200);
		PassengerInfo p4 = new PassengerInfo("Huan", 1, 200);
...
//		
	...
	@Test
	public void test3() {
		FlightInfo f1 = new FlightInfo("toronto", "tm");
		FlightInfo f2 = new FlightInfo("toronto", "tm");
		FlightInfo f3 = new FlightInfo("london", "lk");
		FlightInfo f4 = new FlightInfo("kingston", "lk");
